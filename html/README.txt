olivia the witch wanderer
	discover the goddess's library

sequel to glitch dungeon!!!
html5 & javascript & webgl :O

after 1000 years in development we hope it was worth the wait

-------------------------------------------------------------
Credit::
Built on top of NW.js (http://nwjs.io/)
...
Pure JavaScript custom context menu created with help by
	http://www.codeproject.com/Tips/630793/Context-Menu-on-Right-Click-in-Webpage
	
All the other libraries I used in the scripts/lib/ directory